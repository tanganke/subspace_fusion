...
class Program:
    def __init__(self, cfg: DictConfig):
        ...
        self.results_path = results_path = save_dir / "clip_layer_wise_concrete_adamerging.csv"
        ...
        self.individual_results_path = save_dir / "clip_layer_wise_concrete_adameging_individuals.csv"
        self.tta_results_path = save_dir / "clip_layer_wise_concrete_adamerging_tta.csv"
    ...
    def adamerging(self):
        ...
        results = {"epoch": [], "dataset": [], "acc": []}
        optimizer = torch.optim.Adam([self.model.layer_wise_weight], lr=1e-3, betas=(0.9, 0.999), weight_decay=0.0)
