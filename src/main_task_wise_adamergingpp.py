...
from clip_eval import (eval_single_dataset, eval_single_dataset_head,
...
ft_checks = [
    torch.load("/home/taskarithmetic/checkpoints/" + model + "/" + dataset_name + "/finetuned.pt").state_dict() for dataset_name in exam_datasets
]
...
selected_entries, merged_tv = ties_merging_split(
    tv_flat_checks,
    reset_thresh=K,
