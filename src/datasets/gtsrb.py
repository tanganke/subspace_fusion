...
class GTSRB:
    def __init__(self, preprocess, location=os.path.expanduser("~/data"), batch_size=128, num_workers=0):
        ...
        self.train_dataset = PyTorchGTSRB(root=location, download=False, split="train", transform=preprocess)
        ...
        self.test_dataset = PyTorchGTSRB(root=location, download=False, split="test", transform=preprocess)
